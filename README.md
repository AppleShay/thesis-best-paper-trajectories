...
"Is the Best, the Best?" — Do early-career best-paper awards predict distinct trajectories (productivity, citations, disruption), or reflect pre-existing excellence? [Proposal](https://github.com/AppleShay/thesis-best-paper-trajectories/blob/main/docs/thesis_proposal.pdf)
